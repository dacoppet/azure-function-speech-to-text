...
{
    public static class SpeechToTextHttp
    {
        [FunctionName("SpeechToTextHttp")]
        public static async Task<HttpResponseMessage> RunAsync([HttpTrigger(AuthorizationLevel.Anonymous, "get", "post", Route = null)]HttpRequestMessage req,
          TraceWriter log)
        {
