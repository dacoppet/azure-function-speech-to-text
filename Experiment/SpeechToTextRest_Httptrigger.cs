...
{
    public static class SpeechToTextRest_Httptrigger
    {
        [FunctionName("SpeechToTextRest_Httptrigger")]
        [return: Queue("bingspeechresult", Connection = "Target-Blob")]
        public static async System.Threading.Tasks.Task<string> RunAsync([BlobTrigger("audio/{name}", Connection = "Target-Blob")]Stream audioFile,
